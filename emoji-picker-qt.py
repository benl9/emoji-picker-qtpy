...
def highlight_emoji(newPosition):
    ...
    # last row is not full
        ...
        if (newPosition[0] < fullRowsCount) and (
            newPosition[1] > emojiGridColumnCount - 1
        ):
            newPosition[1] = 0
        ...
        # horizontal wraparound through right edge for NON FULL rows
            ...
            and (newPosition[1] > lastRowEmojiCount - 1)
            and ((selectedEmojiPosition[0] - newPosition[0]) == 0)
        ):
            newPosition[1] = 0
        ...
        elif (newPosition[0] > fullRowsCount - 1) and (
            newPosition[1] > lastRowEmojiCount - 1
        ):
            newPosition[0] = 0
    ...
    widgetToSelect = emojiGridLayout.itemAtPosition(
        selectedEmojiPosition[0], selectedEmojiPosition[1]
    )
    if widgetToSelect:
